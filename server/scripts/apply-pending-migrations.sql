-- =====================================================================
-- Syntra — migrasi tertunda 23..29, digabung untuk sekali jalan.
--
...
-- EXISTS, jadi menjalankannya dua kali tidak merusak apa pun. Tiap bagian
-- adalah transaksinya sendiri (BEGIN/COMMIT bawaan tiap migrasi) — kalau satu
-- gagal, bagian sebelumnya tetap tersimpan dan kamu bisa mengulang dari sini.
--
-- Setelah ini, seluruh endpoint & siaran realtime terbaru aktif:
--   23 daftar follower       26 privasi presence        29 audiens story.new
--   24 edit pesan            27 hapus media (DELETE /media/{id})
--   25 starred messages      28 realtime hapus & reaksi pesan
--
-- Ini berkas turunan (gabungan berkas di server/migrations/). Boleh dihapus
-- setelah dijalankan; sumber kebenarannya tetap masing-masing migrasi.
-- =====================================================================
